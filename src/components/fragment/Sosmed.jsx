...
const Sosmed = () => {
  ...
  return (
      ...
      {/* {arrSosmed.map((item, i) => { */}
          <a href={arrSosmed[0].link}>
            <svg
            ...
            >
              <title>{arrSosmed[0].title}</title>
              <path d={arrSosmed[0].path} />
            </svg>
          </a>
          <a href={arrSosmed[1].link}>
            <svg
              className="fill-current w-[1.30rem] md:w-6"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
              <title>{arrSosmed[1].title}</title>
              <path d={arrSosmed[1].path} />
            </svg>
          </a>
          <a href={arrSosmed[2].link}>
            <svg
              className="fill-current w-[1.30rem] md:w-6"
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
              <title>{arrSosmed[2].title}</title>
              <path d={arrSosmed[2].path} />
            </svg>
          </a>
        {/* })} */}
    </div>
