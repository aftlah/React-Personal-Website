  ...
  return (
    <>
      <div className="flex flex-col ml-[6%] md:ml-5 gap-y-7 md:gap-y-10">
        <ul className="flex flex-col justify-center items-center gap-5 sm:gap-7 ml-3">
          <li className="w-20 h-auto ">
            {/* <AiFillHtml5 className="text-4xl md:text-5xl" /> */}
            <svg
              // width="40"
              // height="40"
              className="h-7 w-8 sm:w-12 sm:h-14  "
              viewBox="0 0 128 128"
      ...
      <div className="flex flex-col gap-y-[1.7rem] md:gap-y-[2.16rem] ">
        <ul className="flex flex-col justify-center items-center gap-5 sm:gap-7 ">
          <li className="w-20 h-auto ">
