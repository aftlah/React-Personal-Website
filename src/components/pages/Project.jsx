...
const Project = ({ id }) => {
  ...
  return (
    <div>
      <section id={id} className="container w-full h-auto p-4 mx-auto mt-20 md:p-0 lg:p-4">
        ...
        <div className="flex flex-col flex-wrap md:justify-start lg:justify-center  items-start w-full py-4 mx-auto mt-9 bg-red-500 gap-x-3  gap-7 md:flex-row md:w-[100%] xl:w-[80%]  xl:gap-14">
          {projects.map((project,i) => (
            <div key={i} className="w-full  h-full rounded-2xl md:w-[20rem] lg:w-[29rem] mx-auto md:mx-5 lg:mx-0 ">
              <AosCom
                  ...
                  <div>
                    ...
                    <div className=" w-[90%] mx-auto my-1">
                      ...
                      <p className="text-slate-500 group w-[30%]">
                        <a href="" className="text-base font-medium">{project.demo}</a>
          ...
          {/* <div className='w-full  h-full rounded-2xl md:w-[26.4rem] mx-auto md:mx-0'>
                        ...
                        <div className='w-full bg-white h-full rounded-2xl md:w-[26.4rem] mx-auto md:mx-0 py-1 border'>
                            <div >
                                <div className='w-[90%] bg-orange-500 h-[13rem] mx-auto mt-5 rounded-2xl md:h-[15rem]'>
                                    <img src="" alt="" />
                                </div>
                    ...
                    <div className='w-full h-full rounded-2xl md:w-[26.4rem] mx-auto md:mx-0'>
                        <AosCom dataAos="fade" dataAosDuration={600} dataAosDelay={80} dataAosOnce="true">
                            <div className=' bg-white h-full rounded-2xl md:w-[26.4rem] mx-auto md:mx-0 py-1 border'>
                                <div>
                                    <div className='w-[90%] bg-orange-500 h-[13rem] mx-auto mt-5 rounded-2xl md:h-[15rem]'>
                                        <img src="" alt="" />
                                    </div>
