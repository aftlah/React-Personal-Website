            ...
            <div className='flex flex-row items-center justify-center w-full h-full gap-10 md:justify-start'>
                ...
                <div className='xl:ml-36 lg:ml-20 md:ml-16'>
                    <AosCom dataAos={"fade-down"} dataAosDuration={500}>
                        <h1 className='text-4xl font-bold md:text-5xl lg:text-6xl lg:hidden'>Hallo Aku, Altaf <span className='text-3xl md:text-5xl'>🖐️</span></h1>
                        <h1 className='hidden ml-1 italic font-semibold md:text-5xl lg:text-2xl lg:block text-slate-600'>Hallo Aku,</h1>
                        <div className='hidden ml-0 text-5xl font-bold lg:block text-slate-900'>Altaf Fattah Amanullah 🖐️</div>
                    </AosCom>
                    ...
                    <div className='flex items-center my-3 gap-x-4 md:my-4 lg:my-6'>
                            ...
                            <p className='font-medium text-slate-500 md:text-lg lg:text-2xl'>Front-end Developer</p>
                    </div>
                        </AosCom>
                    <div >
